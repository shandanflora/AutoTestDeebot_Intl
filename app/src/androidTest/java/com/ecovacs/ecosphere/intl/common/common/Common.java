...
public class Common {
    ...
    private static com.ecovacs.ecosphere.intl.common.Common common = null;
    private Solo solo = null;

    public static com.ecovacs.ecosphere.intl.common.Common getInstance(){
        if(common == null){
            common = new com.ecovacs.ecosphere.intl.common.Common();
        }
        return common;
    }
    ...
    public void logout(int iSleep){
        ...
        com.ecovacs.ecosphere.intl.common.Common.getInstance().clickCtrlById("right", iSleep);
        int i = 0;
        String strUserName;
        do {
        ...
        com.ecovacs.ecosphere.intl.common.Common.getInstance().clickCtrlById("shipping_address", iSleep);
        if(!solo.waitForText(com.ecovacs.ecosphere.intl.common.PropertyData.getProperty("MyInformation"))){
            Log.e("AutoTest—logout", "(AutoTest)Can not return my information!!!");
            return;
        }
        com.ecovacs.ecosphere.intl.common.Common.getInstance().clickCtrlById("exitLogin", iSleep);
        solo.sleep(1000);
        solo.clickOnButton("确定");
        if(!solo.waitForText(com.ecovacs.ecosphere.intl.common.PropertyData.getProperty("Welcome_Regi"))){
            Log.e("AutoTest—logout", "(AutoTest)Can not return my information!!!");
        }
    }
    ...
    public void login(int iSleep){
        ...
        com.ecovacs.ecosphere.intl.common.Common.getInstance().clickCtrlById("login", 0);
        com.ecovacs.ecosphere.intl.common.Common.getInstance().enterTextById("username", com.ecovacs.ecosphere.intl.common.PropertyData.getProperty("mobile"), 0);
        com.ecovacs.ecosphere.intl.common.Common.getInstance().enterTextById("password", PropertyData.getProperty("pwd"), 0);
        com.ecovacs.ecosphere.intl.common.Common.getInstance().clickCtrlById("login", iSleep);
